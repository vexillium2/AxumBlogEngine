...
// 从 crate 根目录导入 AppState 和 Config
...
// 导入路由配置函数
use crate::handler::user::user_routes;
use crate::handler::post::{post_routes, comment_routes_for_post as post_comments_routes}; // 为 /posts/:id/comments 导入一个别名
use crate::handler::comment::comment_routes;
use crate::handler::favorite::favorite_routes;
